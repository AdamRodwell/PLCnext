...
//#component
class TemplateComponent : public ComponentBase, public ProgramComponentBase, private Loggable<TemplateComponent>
{
public: // typedefs
...
#else
    TemplateComponent(ILibrary& library, const String& name);
#endif
...
#if ARP_ABI_VERSION_MAJOR < 2
inline IComponent::Ptr TemplateComponent::Create(Arp::System::Acf::IApplication& application, const String& name)
{
    return IComponent::Ptr(new TemplateComponent(application, name));
}
#endif
