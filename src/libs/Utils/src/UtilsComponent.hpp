...
#include "UtilsComponentProgramProvider.hpp"
...
//#component
class UtilsComponent : public ComponentBase, public ProgramComponentBase, private Loggable<UtilsComponent>
{
public: // typedefs

public: // construction/destruction
    UtilsComponent(IApplication& application, const String& name);
    virtual ~UtilsComponent() = default;
...
private: // methods
    UtilsComponent(const UtilsComponent& arg) = delete;
    UtilsComponent& operator= (const UtilsComponent& arg) = delete;

public: // static factory operations
    static IComponent::Ptr Create(Arp::System::Acf::IApplication& application, const String& name);

private: // fields
    UtilsComponentProgramProvider programProvider;
...
inline IComponent::Ptr UtilsComponent::Create(Arp::System::Acf::IApplication& application, const String& name)
{
    return IComponent::Ptr(new UtilsComponent(application, name));
}
